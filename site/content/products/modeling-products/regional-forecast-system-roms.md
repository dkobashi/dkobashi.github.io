...
## Computer Systems ##
I can use various computer systems to implement operational forecasts depending on client/my resources. Here is the list of examples. Currently, I am using a local workstation for testing ocean models listed on my website.
- Amazon Web Services
